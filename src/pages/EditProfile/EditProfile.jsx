...
import "./EditProfile.css"; // reuse styles
    ...
    <div className="container my-5 d-flex justify-content-center">
      ...
      >
        <div className="card-body p-4">
          <h4 className="mb-3">{t("Edit Profile")}</h4>
          <form onSubmit={handleSave}>
            <div className="mb-3">
              <label className="form-label fw-semibold">{t("Full Name")}</label>
              <input
                type="text"
            ...
            <div className="mb-3">
              ...
              <input
                ...
                placeholder={t("New password (leave empty to keep current)")}
                value={password}
